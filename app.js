...
// NOTE: The value/argument that will be passed in for the "pokemon" paramenter will be the response recieved from an Axios request to the PokeAPI.
...
// The getPokemonData function makes an Axios GET reuqest to the PokeAPI using a specific pokemon ID/number then takes the returned data and passes it into the createPokeCard function
...
// The getPokemon function loops through all the pokemon IDs from 1 to 151 and runs/exercutes the getPokemonData function for each ID
